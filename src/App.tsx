    ...
    <>
        <div ref={rootRef} className={style.root} onScroll={(ev)=>{
            ...
            <main className={style.main}>
                ...
                <div className={clsx(style.toTop, headerHidden && style.headerHidden)} onClick={() =>{(rootRef.current as HTMLElement).scrollTop = 0}}>
                ...
                <div className={style.contact} id="contact">
                    ...
                    <div>
                        <i className="fa-solid fa-copy" onClick={()=>{clipboard("+48501588623")}}></i>
                        <i className="fa-solid fa-phone" onClick={()=>{window.open('tel:+48501588623');}}></i>
                    </div><br/>
                        <br/>
                        <h3>Zachęcamy również do pisania wiadomości e-mail</h3>
                        rafal7witczak@gmail.com<br/>
                    <div>
                        <i className="fa-solid fa-copy" onClick={()=>{clipboard("rafal7witczak@gmail.com")}}></i>
                        <i className="fa-solid fa-envelope" onClick={()=>{window.open("mailto:rafal7witczak@gmail.com")}}></i>
                    </div>
                        <br/><br/>
                        ...
                        45-064 Opole<br/>
                    <div>
                        <i className="fa-solid fa-copy" onClick={()=>{clipboard("Rzemieślnik ul. Ozimska 14 45-064 Opole")}}></i>
